...
def login():
    ...
    #判断运营商
    if var3.get() == 2:
        url = "http://10.0.1.5/drcom/login?callback=dr1003&DDDDD=" + sid + "%40cmcc" + "&upass=" + pwd + "&0MKKey=123456&R1=0&R2=&R3=0&R6=0&para=00&v6ip=&terminal_type=1&lang=zh-cn&jsVersion=4.1&v=1058&lang=zh "                                                                                                 "&v=1058&lang=zh "
    elif var3.get() == 3:
    ...
    if find_str in req:
        ...
        if var1.get() == 0:
            ...
            SaveLoginInfo.SaveInfo(sid, pwd)
    else:
        print('登录失败')
